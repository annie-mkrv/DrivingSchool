...
namespace Catalog
{
    public class ClasessesDateTimeTemplateSelector : DataTemplateSelector
    {
    ...
    public sealed partial class UserMyClasses : Page
    {
        ...
        private async void SelectDate(object sender, RoutedEventArgs e)
        {
            ...
            Student student = Auth.UserStudent;
            var studentId = Auth.UserStudent.id ?? 0;
            var classes = await ClassesService.GetForStudent(student);

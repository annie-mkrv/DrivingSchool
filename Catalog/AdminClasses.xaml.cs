...
namespace Catalog
{
    public class AdminClasessDateTimeTemplateSelector : DataTemplateSelector
    {
    ...
    /// </summary>
    public sealed partial class AdminClasses : Page
    {
        ...
        //    ClassesListBox.ItemsSource = await ClassesService.GetAll(date);
        //}
